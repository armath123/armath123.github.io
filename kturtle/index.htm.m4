...
<body>
	...
	<main>
		<ul class="menu menu-with-icons">
			...
			<li>
				<a href="/kturtle/exercises">
					<img src="/img/articles/kturtle/exercises/kturtle-exercises.webp" width="128" height="128">Կրիա - Վարժություններ<span style="color: red;">*</span>
				</a>
			</li>
		</ul>
	</main>
