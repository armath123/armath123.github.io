...
<body class="materials-page single">
    ...
    <main>
        ...
        <div class="page-content">
            ...
            <section>
                <h2>Բայց եկեք մի պահ խոսենք խաղերից ու տարածությունից</h2>
            </section>
            ...
            <section>
                <h2>Մյոբիուսի ժապավենի կիրառությունները</h2>
            </section>
            ...
            <section>
                <h2>DIY - պատրաստենք Մյոբյուսի ժապավեն ինքներս</h2>
            </section>
        </div>
    </main>
</body>
