...
<head>
    ...
    <title>Լույսի տարալուծումը կամ դիսպերսիա</title>
</head>
    ...
    <main>
        ...
        <div class="page-content">
            ...
            <section>
                ...
                <br><br><br>
                <div>
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/yl-Ms_ek-kE?si=Fr-5wQyV9SnD13cA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <pre>
    Ժամանակ
    Թարգմանությունը՝ Գոհար Գրիգորյանի
    https://granish.org/pink-folyd/
